        ...
        <>
            <div className="hero w-full min-h-screen relative z-10">
                ...
                <div className="content flex flex-col justify-center items-center absolute bottom-0 left-0 w-full h-full bg-gradient-to-b from-black/50 to-transparent">
                    <h1 className=' text-4xl font-semibold text-center'>Travel. Galaxies</h1>
                    <p className='w-[60vw] text-center'>Explore the beauty of space, stars, and planets with us — journey beyond Earth, uncover cosmic wonders, and let your adventure begin among the galaxies, Galaxy Travel is your gateway to exploring the universe. We offer unforgettable journeys across planets and galaxies, combining adventure, comfort, and cosmic wonder.</p>
                    <div className="btns">
