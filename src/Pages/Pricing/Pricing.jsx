...
const Pricing = () => {
    ...
    return (
        <>
        <Header heading='Packages are Below' icon={<GiMoneyStack className="text-2xl"/>}/>
            <h1 className='heading flex justify-center items-center text-4xl font-semibold' style={{marginTop:"8vh"}}>Pricing Page</h1>
                ...
                <div ref={slideref}  className="container flex gap-6 overflow-x-auto overflow-y-hidden scroll-smooth ">
                    {travelPackages.map((item) => (
                        ...
                        >
                            ...
                            <button className="service-btn w-full cursor-pointer bg-blue-600 hover:bg-blue-700 text-white  rounded-lg transition" style={{padding: "8px 0"}}>
                                Book Now
                            </button>
                        </div>
                    ))}
